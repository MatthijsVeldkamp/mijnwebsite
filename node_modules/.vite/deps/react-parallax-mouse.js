...
var require_dist = __commonJS({
  "node_modules/react-parallax-mouse/dist/index.js"(exports) {
    ...
    exports.MouseParallaxChild = function(n2) {
      ...
      return r.default.createElement(r.default.Fragment, null, r.default.createElement(t.animated.div, o({}, { className: f }, { style: y }), p));
    }, exports.MouseParallaxContainer = function(n2) {
      var u2 = n2.globalFactorX, l2 = void 0 === u2 ? 1 : u2, c = n2.globalFactorY, s = void 0 === c ? 1 : c, d = n2.resetOnLeave, f = n2.useWindowMouseEvents, v = n2.inverted, p = n2.springConfig, m = n2.enabled, x = void 0 === m || m, y = n2.containerStyle, g = n2.className, w = n2.children, b = t.useSpring(function() {
        return o(o({}, a), p ? { config: p } : {});
      }), C = b[0], E = b[1], h = function() {
        return E.start(a);
      }, M = e.useState({ current: null }), L = M[0], O = M[1], P = e.useCallback(function(e2) {
        null !== e2 && O({ current: e2 });
      }, []), S = e.useCallback(function(e2) {
        var t2 = L.current ? L.current.getBoundingClientRect() : { left: 0, top: 0 };
        return { x: e2.clientX - t2.left, y: e2.clientY - t2.top };
      }, [L]), j = e.useCallback(function(e2) {
        if (L.current) {
          var t2 = L.current.clientHeight, n3 = L.current.clientWidth, r2 = S(e2), o2 = { x: (n3 / 2 - r2.x) * l2 * (v ? -1 : 1), y: (t2 / 2 - r2.y) * s * (v ? -1 : 1) };
          E.start(o2);
        }
      }, [L, S, v]);
      e.useEffect(function() {
        return x && f && L.current && (window.addEventListener("mousemove", j, false), d && window.addEventListener("mouseout", h, false)), function() {
          x && f && L.current && (window.removeEventListener("mousemove", j, false), d && window.removeEventListener("mouseout", h, false));
        };
      }, [L, j, d, f, x]);
      var k = { onMouseMove: x && !f ? j : void 0, onMouseLeave: x && !f && d ? h : void 0 };
      return r.default.createElement(i.Provider, { value: C }, r.default.createElement("div", o({ id: "mouse-parallax-container", ref: P, style: o({ overflow: "hidden", position: "relative" }, y) }, { className: g }, k), w));
